            ...
            <div class="col-4 offset-4 shadow py-4">
                ...
                <div class="user-info px-3">
                    <ul class="font-ubuntu navbar-nav ">
                        ...
                        <li class="nav-link d-flex justify-content-center"><button class="btn btn-warning rounded-pill text-dark px-5"><a href="logout.php" class="link">logout</a></button></li>
                    </ul>
                </div>
            </div>
        </div>
        <p class="d-flex justify-content-center m-4">Copyright © 2023 All rights reserved | This template is made by Eng/ Ahmed Elgabry</p>
    </div>
</section>
